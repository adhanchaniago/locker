...
<body>
        ...
        <ul id="nav-mobile" class="side-nav ">
          <li>
            <div class="user-view">
              ...
              <a href="#">
                <span class="name grey-text text-darken-4">Hesen</span>
              </a>
              <a href="#">
                <span class="email grey-text text-darken-4">hesendwiyatmiko@gmail.com</span>
              </a>
            </div>
          </li>
  ...
  <ul class="side-nav fixed">
    ...
    <li><a href="index.php"><i class="fas fa-home"></i>&nbsp  Home</a></li>
    <li><a href="records.php?module=&halaman=1"><i class="fas fa-book"></i>&nbsp  Record</a></li>
    <li><a href="locker.php?module=&halaman=1"><i class="fas fa-box"></i>&nbsp  Locker</a></li>
	<li><a href="maintenance.php?module=&halaman=1"><i class="fas fa-wrench"></i>&nbsp  Meintenance</a></li>
	
    <li><a href="users.php"><i class="fas fa-users"></i>&nbsp  Users</a></li>
    <li><a href="admin.php"><i class="fas fa-user"></i>&nbsp  Admin</a></li>
    <li><a href="report.php"><i class="fas fa-chart-line"></i>&nbsp  Report</a></li>
	<li><a href="bagian.php"><i class="fas fa-podcast"></i>&nbsp  Bagian</a></li>
