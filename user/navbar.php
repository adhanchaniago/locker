    ...
    <nav class="blue darken-2 hide-on-med-and-up" role="navigation">
      <div class="nav-wrapper container">
        ...
        <ul id="nav-mobile" class="side-nav ">
            ...
            <div class="user-view">
              ...
              <div class="row">
                ...
                <div class="col s8">
				  ...
				  <a href="#">
                    <span class="name white-text"><?php echo $_SESSION['s_id'].' / '.$_SESSION['s_bagian']; ?></span>
            </a>
                  <a href="#">
		  ...
		  <li><a href="maintenance.php"><i class="fas fa-wrench"></i>&nbsp  Pengajuan Perbaikan Locker</a></li>
